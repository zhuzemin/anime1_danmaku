...
Other function:
5: after "Search Danmaku", "Download Danmaku" Button will be ready, it's use for download Danmaku as ".ass" file. 
6: Volume adjust: ¡ü¡ý(arrow key).
7: Danmaku speed adjust(temporally): use command: "!dmspd:xxx", 
*type it in Input inside Player, "xxx" mean percentage of speed for Danmaku, (100-200%), more larger more slower, default: 100.
8: post Danmaku: "!dm:xxx", 
*specify Danmaku type/size/color: "!dm:xxx{{type,size,color}}", 
*type: L2R/R2L/btm/top, size: 12/16/18/25/36/45/64, color: black/blue/green/orange/pink/purple/red/silver/yellow/white/gold.
9: open Disqus in anime1.me: !comment
