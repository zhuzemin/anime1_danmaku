...
function isMobile(){var e,t=!1;return e=navigator.userAgent||navigator.vendor||window.opera,(/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(e)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(e.substr(0,4)))&&(t=!0),t}var CommentLoader=function(){function t(){this.parseOne=function(){throw new Error("Not Implemented")},this.parseMany=function(){throw new Error("Not Implemented")}}function e(e){this._commentManager=e,this._responseType="text/xml",this._parser=new t}var a=["text/xml","text/plain","application/json"];return e.prototype.setParser=function(e){return this._parser=e,this},e.prototype.setType=function(e){if(a.indexOf(e)<0)throw new Error("Unknown type: "+e);return this._responseType=e,this},e.prototype._fetch=function(e,t){return fetch(t,{method:e}).then(function(e){if(!e.ok)throw new Error("HTTP error, status = "+e.status);if("application/json"===this._responseType)return e.json();if("text/plain"===this._responseType)return e.text();if("text/xml"===this._responseType)return e.text().then(function(e){return(new DOMParser).parseFromString(e,this._responseType)}.bind(this));throw new Error("Unrecognized response type")}.bind(this))},e.prototype.load=function(e,a){return new Promise(function(e,t){e((new DOMParser).parseFromString(a,"text/xml"))}).then(function(e){return this._parser.parseMany(e)}.bind(this)).then(function(e){this._commentManager.load(e)}.bind(this)).catch(function(e){alert(e)})},e}(),ABP={version:"0.8.0"};!function(){"use strict";if(ABP){var x=function(e,t,a,n){var r=null;if("text"===e)return document.createTextNode(t);for(var i in r=document.createElement(e),t)if("style"!==i&&"className"!==i)r.setAttribute(i,t[i]);else if("className"===i)r.className=t[i];else for(var s in t.style)r.style[s]=t.style[s];if(a)for(var o=0;o<a.length;o++)null!=a[o]&&r.appendChild(a[o]);return n&&"function"==typeof n&&n(r),r},P=function(e,t){return null!=e&&0<=e.className.split(" ").indexOf(t)},k=function(e,t){var a={};for(var n in t)e&&void 0!==e[n]?a[n]=e[n]:a[n]=t[n];return a};ABP.create=function(e,t){var a,n=e;if(t=k(t=t||{},{replaceMode:!0,width:512,height:384,src:"",mobile:!1}),"string"==typeof e&&(a=e,n=document.getElementById(a)),P(n,"ABP-Unit"))r=n;else{var r=x("div",{className:"ABP-Unit",style:{width:t.width+"px",height:t.height+"px"}});n.appendChild(r)}0<r.children.length&&t.replaceMode&&(r.innerHTML="");var i=[],s=[];if("string"==typeof t.src)t.src=x("video",{autobuffer:"true",dataSetup:"{}"},[x("source",{src:t.src})]),i.push(t.src);else if(t.src.hasOwnProperty("playlist"))for(var o=t.src.playlist,l=0;l<o.length;l++){if(o[l].hasOwnProperty("sources")){var c=[];for(var d in o[l].sources)c.push(x("source",{src:o[l].sources[d],type:d}));i.push(x("video",{autobuffer:"true",dataSetup:"{}"},c))}else o[l].hasOwnProperty("video")?i.push(o[l].video):console.log("No recognized format");s.push(o[l].comments)}else i.push(t.src);r.appendChild(x("div",{className:"ABP-Video",tabindex:"10"},[x("div",{className:"ABP-Container"}),i[0]])),r.appendChild(x("div",{className:"ABP-Text"},[x("input",{type:"text"})])),r.appendChild(x("div",{className:"ABP-Control"},[x("div",{className:"button ABP-Play"}),x("div",{className:"progress-bar"},[x("div",{className:"bar dark"}),x("div",{className:"bar"})]),x("div",{className:"button ABP-CommentShow"}),x("div",{className:"button ABP-FullScreen"})]));var u=ABP.bind(r,t.mobile);if(0<i.length){u.loader=new CommentLoader(u.cmManager).setParser(new BilibiliFormat.XMLParser);var m=i[0];u.gotoNext=function(){var e=i.indexOf(m)+1;if(e<i.length){(m=i[e]).style.display="";var t=u.video.parentNode;t.removeChild(u.video),t.appendChild(m),u.video.style.display="none",u.video=m,u.swapVideo(m),m.addEventListener("ended",function(){u.gotoNext()})}e<s.length&&null!==s[e]&&u.loader.load("GET",s[e])},m.addEventListener("ended",function(){u.gotoNext()}),0<s.length&&u.loader.load("GET",s[0])}return u},ABP.load=function(e,t,a,n){},ABP.bind=function(n,e,t){var s={btnPlay:null,barTime:null,barLoad:null,divComment:null,btnFull:null,btnDm:null,video:null,divTextField:null,txtText:null,cmManager:null,defaults:{w:0,h:0},state:k(t,{fullscreen:!1,commentVisible:!0,allowRescale:!1,autosize:!1}),createPopup:function(e,t){if(!0===n.hasPopup)return!1;var a=x("div",{className:"ABP-Popup"},[x("text",e)]);return a.remove=function(){a.isRemoved||(a.isRemoved=!0,n.removeChild(a),n.hasPopup=!1)},n.appendChild(a),n.hasPopup=!0,"number"==typeof t&&setTimeout(function(){a.remove()},t),a},removePopup:function(){for(var e=n.getElementsByClassName("ABP-Popup"),t=0;t<e.length;t++)null!=e[t].remove?e[t].remove():e[t].parentNode.removeChild(e[t]);n.hasPopup=!1},swapVideo:null};if(s.swapVideo=function(e){e.addEventListener("timeupdate",function(){b||(s.barTime.style.width=e.currentTime/e.duration*100+"%")}),e.addEventListener("ended",function(){s.btnPlay.className="button ABP-Play",s.barTime.style.width="0%"}),e.addEventListener("progress",function(){if(null!=this.buffered){try{this.buffered.start(0);var e=this.buffered.end(0)}catch(e){return}var t=e/this.duration*100;s.barLoad.style.width=t+"%"}}),e.addEventListener("loadedmetadata",function(){if(null!=this.buffered){try{this.buffered.start(0);var e=this.buffered.end(0)}catch(e){return}var t=e/this.duration*100;s.barLoad.style.width=t+"%"}}),e.isBound=!0;var t=0;s.cmManager&&(s.cmManager.clear(),e.addEventListener("progress",function(){t==e.currentTime?(e.hasStalled=!0,s.cmManager.stop()):t=e.currentTime}),window&&window.addEventListener("resize",function(){s.cmManager.setBounds()}),e.addEventListener("timeupdate",function(){!1!==s.cmManager.display&&(e.hasStalled&&(s.cmManager.start(),e.hasStalled=!1),s.cmManager.time(Math.floor(1e3*e.currentTime)))}),e.addEventListener("play",function(){s.cmManager.start();try{var e=this.buffered.end(0)/this.duration*100;s.barLoad.style.width=e+"%"}catch(e){}}),e.addEventListener("ratechange",function(){null!=s.cmManager.def.globalScale&&0!==e.playbackRate&&(s.cmManager.def.globalScale=1/e.playbackRate,s.cmManager.rescale())}),e.addEventListener("pause",function(){s.cmManager.stop()}),e.addEventListener("waiting",function(){s.cmManager.stop()}),e.addEventListener("playing",function(){s.cmManager.start()}))},null!==n&&null!==n.getElementsByClassName){s.defaults.w=n.offsetWidth,s.defaults.h=n.offsetHeight;var a=n.getElementsByClassName("ABP-Video");if(!(a.length<=0)){var r=null;for(var i in a[0].children)if(null!=a[0].children[i].tagName&&"VIDEO"===a[0].children[i].tagName.toUpperCase()){r=a[0].children[i];break}a[0]&&e&&(a[0].style.bottom="0px");var o=a[0].getElementsByClassName("ABP-Container");if(0<o.length&&(s.divComment=o[0]),null!==r){s.video=r;var l=n.getElementsByClassName("ABP-Play");if(!(l.length<=0)){s.btnPlay=l[0];var c=n.getElementsByClassName("progress-bar");if(!(c.length<=0)){s.barHitArea=c[0];var d=c[0].getElementsByClassName("bar");s.barTime=d[0],s.barLoad=d[1];var u=n.getElementsByClassName("ABP-FullScreen");if(!(u.length<=0)){s.btnFull=u[0];var m=n.getElementsByClassName("ABP-Text");if(0<m.length){s.divTextField=m[0];var p=m[0].getElementsByTagName("input");0<p.length&&(s.txtText=p[0])}var h=n.getElementsByClassName("ABP-CommentShow");if(0<h.length&&(s.btnDm=h[0]),"undefined"!=typeof CommentManager&&(s.cmManager=new CommentManager(s.divComment),s.cmManager.display=!0,s.cmManager.init(),s.cmManager.clear(),window&&window.addEventListener("resize",function(){s.cmManager.setBounds()})),e){var v=n.getElementsByClassName("ABP-Control");0<v.length&&(s.controlBar=v[0]);var f=-1,g=function(){s.controlBar.style.display="none",s.divTextField.style.display="none",s.divComment.style.bottom="0px",s.cmManager.setBounds()};s.divComment.style.bottom=s.controlBar.offsetHeight+s.divTextField.offsetHeight+"px";var y=function(){s.controlBar.style.display="",s.divTextField.style.display="",s.divComment.style.bottom=s.controlBar.offsetHeight+s.divTextField.offsetHeight+"px";try{-1!=f&&(clearInterval(f),f=-1),f=setInterval(function(){document.activeElement!==s.txtText&&(g(),clearInterval(f),f=-1)},2500)}catch(e){console.log(e)}};n.addEventListener("touchmove",y),n.addEventListener("mousemove",y),f=setTimeout(function(){g()},4e3)}if(!0!==r.isBound){s.swapVideo(r),s.btnFull.addEventListener("click",function(){s.state.fullscreen=P(n,"ABP-FullScreen"),(s.state.fullscreen?function(e,t){if(null!=e){var a=e.className.split(" ");0<=a.indexOf(t)&&a.splice(a.indexOf(t),1),e.className=a.join(" ")}}:function(e,t){if(null!=e){var a=e.className.split(" ");a.indexOf(t)<0&&a.push(t),e.className=a.join(" ")}})(n,"ABP-FullScreen"),s.state.fullscreen=!s.state.fullscreen,s.cmManager&&s.cmManager.setBounds(),s.state.allowRescale&&(s.state.fullscreen?0<s.defaults.w&&(s.cmManager.def.scrollScale=n.offsetWidth/s.defaults.w):s.cmManager.def.scrollScale=1)}),s.btnDm.addEventListener("click",function(){0==s.cmManager.display?(s.cmManager.display=!0,s.cmManager.start()):(s.cmManager.display=!1,s.cmManager.clear(),s.cmManager.stop())});var b=!(s.barTime.style.width="0%");s.barHitArea.addEventListener("mousedown",function(e){b=!0}),document.addEventListener("mouseup",function(e){b=!1}),s.barHitArea.addEventListener("mouseup",function(e){b=!1;var t=e.layerX/this.offsetWidth*s.video.duration;4<Math.abs(t-s.video.currentTime)&&s.cmManager&&s.cmManager.clear(),s.video.currentTime=t}),s.barHitArea.addEventListener("mousemove",function(e){b&&(s.barTime.style.width=100*e.layerX/this.offsetWidth+"%")}),s.btnPlay.addEventListener("click",function(){s.video.paused?(s.video.play(),this.className="button ABP-Play ABP-Pause"):(s.video.pause(),this.className="button ABP-Play")}),n.addEventListener("keydown",function(e){e&&32==e.keyCode&&document.activeElement!==s.txtText&&(s.btnPlay.click(),e.preventDefault())}),n.addEventListener("touchmove",function(e){event.preventDefault()});var M=null;n.addEventListener("touchstart",function(e){0<e.targetTouches.length&&(M=e.targetTouches[0])}),n.addEventListener("touchend",function(e){if(0<e.changedTouches.length&&null!=M){var t=e.changedTouches[0].pageX-M.pageX,a=e.changedTouches[0].pageY-M.pageY;if(Math.abs(t)<20&&Math.abs(a)<20)return void(M=null);Math.abs(t)>3*Math.abs(a)?0<t?s.video.paused&&s.btnPlay.click():s.video.paused||s.btnPlay.click():Math.abs(a)>3*Math.abs(t)&&(s.video.volume=a<0?Math.min(1,s.video.volume+.1):Math.max(0,s.video.volume-.1)),M=null}})}if(null!==s.txtText&&(s.txtText.addEventListener("click",function(e){if(null!=this.value&&(/^!/.test(this.value)?this.style.color="#5DE534":this.style.color="",/^!/.test(this.value))){var t=this.value.substring(1).split(":");switch(t.shift()){case"help":if(t.length<1)s.createPopup("提示信息：",2e3);else{var a;a=2==t.length&&"number"==typeof parseInt(t[1])?parseInt(t[1]):2e3;s.createPopup(t[0],a);null!==s.cmManager&&s.cmManager.clear()}break;case"speed":case"rate":case"spd":if(t.length<1)s.createPopup("速度调节：输入百分比【 1% - 300% 】",2e3);else{if(NaN!=(r=parseInt(t[0]))){var n=Math.min(Math.max(r,1),300);s.video.playbackRate=n/100}null!==s.cmManager&&s.cmManager.clear()}break;case"DmkSpd":if(t.length<1)s.createPopup("弹幕速度调节：输入百分比【 100% - 200% 】",2e3);else{var r;if(NaN!=(r=parseInt(t[0]))){n=Math.min(Math.max(r,100),200);s.cmManager.options.scroll.scale=n/100}null!==s.cmManager&&s.cmManager.clear()}break;case"off":s.cmManager.display=!1,s.cmManager.clear(),s.cmManager.stop();break;case"on":s.cmManager.display=!0,s.cmManager.start();break;case"cls":case"clear":null!==s.cmManager&&s.cmManager.clear();break;case"pp":case"pause":s.video.pause();break;case"p":case"play":s.video.play();break;case"vol":case"volume":if(0==t.length)s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",2e3);else{var i=parseInt(t[0]);null!==i&&NaN!==i&&(s.video.volume=Math.max(Math.min(i,100),0)/100),s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",2e3)}}this.value=""}}),s.txtText.addEventListener("keyup",function(e){if(null!=this.value)if(/^!/.test(this.value)?this.style.color="#5DE534":this.style.color="",null!=e&&13===e.keyCode){if(""==this.value)return;if(/^!/.test(this.value)){var t=this.value.substring(1).split(":");switch(t.shift()){case"help":s.createPopup("提示信息：",2e3);break;case"speed":case"rate":case"spd":if(t.length<1)s.createPopup("速度调节：输入百分比【 1% - 300% 】",2e3);else{if(NaN!=(n=parseInt(t[0]))){var a=Math.min(Math.max(n,1),300);s.video.playbackRate=a/100}null!==s.cmManager&&s.cmManager.clear()}break;case"DmkSpd":if(t.length<1)s.createPopup("弹幕速度调节：输入百分比【 100% - 200% 】",2e3);else{var n;if(NaN!=(n=parseInt(t[0]))){a=Math.min(Math.max(n,100),200);s.cmManager.options.scroll.scale=a/100}null!==s.cmManager&&s.cmManager.clear()}break;case"off":s.cmManager.display=!1,s.cmManager.clear(),s.cmManager.stop();break;case"on":s.cmManager.display=!0,s.cmManager.start();break;case"cls":case"clear":null!==s.cmManager&&s.cmManager.clear();break;case"pp":case"pause":s.video.pause();break;case"p":case"play":s.video.play();break;case"vol":case"volume":if(0==t.length)s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",2e3);else{var r=parseInt(t[0]);null!==r&&NaN!==r&&(s.video.volume=Math.max(Math.min(r,100),0)/100),s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",2e3)}}this.value=""}}else if(null!=e&&38===e.keyCode)if(e.shiftKey){if(null!==s.cmManager){var i=Math.min(Math.round(100*s.cmManager.def.opacity)+5,100);s.cmManager.def.opacity=i/100,s.removePopup();s.createPopup("弹幕透明度："+Math.round(i)+"%",800)}}else{s.video.volume=Math.round(Math.min(100*s.video.volume+5,100))/100,s.removePopup();s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",800)}else if(null!=e&&40===e.keyCode)if(e.shiftKey){if(null!==s.cmManager){i=Math.max(Math.round(100*s.cmManager.def.opacity)-5,0);s.cmManager.def.opacity=i/100,s.removePopup();s.createPopup("弹幕透明度："+Math.round(i)+"%",800)}}else{s.video.volume=Math.round(Math.max(100*s.video.volume-5,0))/100,s.removePopup();s.createPopup("目前音量："+Math.round(100*s.video.volume)+"%",800)}})),"undefined"!=typeof CommentManager&&s.state.autosize){var w=function(){if(0!==r.videoHeight&&0!==r.videoWidth){var e=r.videoHeight/r.videoWidth,t=n.offsetWidth,a=n.offsetHeight;a/t<e?(n.style.width=a/e+"px",n.style.height=a+"px"):(n.style.width=t+"px",n.style.height=t*e+"px"),s.cmManager.setBounds()}};r.addEventListener("loadedmetadata",w),w()}return s}}}}}}}}}();
var config = {
    'debug': false
}
...
function bilibili() {
    ...
    title=array[1];
    var EpisodeCurrent=array[2];
    var href="https://search.bilibili.com/bangumi?keyword="+simplized(title);
    var search=new ObjectRequest(href);
    var SearchResult;
    request(search,function (responseDetails) {
        var responseText=responseDetails.responseText;
