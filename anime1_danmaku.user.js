...
function ABP_Init(object){
    ...
    ButtonFullscreen_ABP.addEventListener("click",function (){
        ...
        var message=setInterval(function () {
            if(!count&&parseInt(abp.video.currentTime)>=10){
                abp.createPopup("Command adjust Danmaku speed: !MdkSpd:150",10000);
                count=true;
            }
            else if(count){
