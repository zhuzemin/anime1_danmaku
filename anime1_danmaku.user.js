    ...
    if(window.location.href.includes("bilibili.com")){
        ...
        if(window.location.href.match(/^https:\/\/anime1\.me\/\d*$/)){
            ...
            CreateButton('Load Danmaku',function () {
                ...
                else if(input.value.match(/(api\.bilibili\.com)|(ani\.gamer\.com\.tw)/)!=null) {
