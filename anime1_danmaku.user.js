...
// @description anime1.me / video.eyny.com / www.tucao.one 显示/发送弹幕(bilibili.com / ani.gamer.com.tw)
...
function init(){
    ...
    if(window.location.href.includes("bilibili.com")){
        ...
        CreateButton('Detect Danmaku',function () {
            var cid;
...
function ABP_Init(object){
    try{
        ...
        if(TucaoEnable){
            TucaoStatus=GetDanmaku(OtherInsertTucao);
                        ...
                        if(TucaoStatus){
                            ...
                            if (params!=null) {
                                ...
                                if(params.length==3){
                                    ...
                                    size=params[1];
                                    color=params[2];
                                    if(!["25","36","45","64"].includes(size)){
                                        abp.createPopup("[Error] size wrong.", 2000);
                                        
                                    }
                                    if(["scl","btm","top"].includes(mode)){
                                        if(mode.toLowerCase()=="scl"){
                                            mode=1;
                                        }
                            ...
                            abp.createPopup("[Error] tucao.one search failed, can not post Danmaku.", 2000);
                        }
                    }
                        break;
                }
