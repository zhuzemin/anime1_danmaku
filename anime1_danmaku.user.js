...
setUserPref(
    ...
    '100',
    'Set Danmaku speed',
    `Enter percentage of speed for Danmaku, (100-200%), more larger more slower, default: 100.`,
    ','
);
...
Format: Layer, Start, End, Style, Name, MarginL, MarginR, MarginV, Effect, Text
      ...
      */}),config,n,{alpha:hexAlpha(config.opacity)}),o=function(t){t=100*t^0;var n=[[100,2],[60,2],[60,2],[1/0,0]].map(function(n){var e=t%n[0];return t=(t-e)/n[0],function(t,n){for(t=""+t;t.length<n;)t="0"+t;return t}(e,n[1])}).reverse();return n.slice(0,-1).join(":")+"."+n[3]},u={R2L:(e=function(t){return function(n){return t(n)+function(t){var n="",e=t.color.split(/(..)/).filter(function(t){return t}).map(function(t){return parseInt(t,16)});return"FFFFFF"!==t.color&&(n+="\\c&H"+t.color.split(/(..)/).reverse().join("")),.299*e[0]+.587*e[1]+.114*e[2]<48&&(n+="\\3c&HFFFFFF"),25!==t.size&&(n+="\\fs"+t.size),n}(n)}})(function(t){return"\\move("+[t.poss.x,t.poss.y,t.posd.x,t.posd.y].join(",")+")"}),Fix:e(function(t){return"\\pos("+[t.poss.x,t.poss.y].join(",")+")"})};return r+t.map(function(t){return"Dialogue: "+[0,o(t.stime),o(t.dtime),t.type,",20,20,2,,"].join(",")+"{"+u[t.type](t)+"}"+t.text.replace(/{/g,"｛").replace(/}/g,"｝").replace(/\r|\n/g,"")}).filter(function(t){return t}).join("\n")},normalDanmaku=function(t,n,e,r,o){return function(){var u=[{p:-1/0,m:0,tf:1/0,td:1/0,b:!1},{p:n,m:1/0,tf:1/0,td:1/0,b:!1},{p:n-e,m:n,tf:1/0,td:1/0,b:!0}];return function(e,i,a,c){var f=t/(i+t)*r+e;!function(t,n){u=u.filter(function(e){return e.tf>t||e.td>n})}(e,f);var m=function(t,e,r,i){var a=[];u.forEach(function(o){if(!(o.m>n)){var c=o.m,f=c+t,m=e,s=r;u.forEach(function(t){t.p>=f||t.m<=c||t.b&&i||(m=Math.max(m,t.tf),s=Math.max(s,t.td))}),a.push({p:c,r:Math.max(m-e,s-r)})}}),a.sort(function(t,n){return t.p-n.p});var c=o;return a=a.filter(function(t){return!(t.r>=c||(c=t.r,0))})}(a,e,f,c);if(!m.length)return null;var s=m.map(function(t){return[function(t){return t.r>o?-1/0:1-hypot(t.r/o,t.p/n)*Math.SQRT1_2}(t),t]}).reduce(function(t,n){return t[0]>n[0]?t:n})[1],l=e+s.r,p=i/(i+t)*r+l,d=r+l;return function(t,n,e,r){u.push({p:t,m:n,tf:e,td:r,b:!1})}(s.p,s.p+a,p,d),{top:s.p,time:l}}}}(config.playResX,config.playResY,config.bottom,config.r2ltime,config.max_delay),sideDanmaku=function(t,n,e,r){return function(){var o=[{p:-1/0,m:0,td:1/0,b:!1},{p:t,m:1/0,td:1/0,b:!1},{p:t-n,m:t,td:1/0,b:!0}],u=function(t,n,e,r){var u=e;return o.forEach(function(e){e.p>=n||e.m<=t||e.b&&r||(u=Math.max(u,e.td))}),{r:u-e,p:t,m:n}};return function(n,i,a,c){!function(t){o=o.filter(function(n){return n.td>t})}(n);var f=(a?function(n,e,r){var i=[];return o.forEach(function(o){o.m>t||i.push(u(o.m,o.m+n,e,r))}),i}:function(t,n,e){var r=[];return o.forEach(function(o){o.p<0||r.push(u(o.p-t,o.p,n,e))}),r})(i,n,c);if(!f.length)return null;var m,s,l,p=f.map(function(n){return[function(n,e){if(n.r>r)return-1/0;var o;return 1-(n.r/r*(31/32)+(o=n.p,(e?o:t-o)/t*(1/32)))}(n,a),n]}).reduce(function(t,n){return t[0]>n[0]?t:n})[1];return m=p.p,s=p.m,l=p.r+n+e,o.push({p:m,m:s,td:l,b:!1}),{top:p.p,time:p.r+n}}}}(config.playResY,config.bottom,config.fixtime,config.max_delay),setPosition=function(t){var n=normalDanmaku(),e=sideDanmaku();return t.sort(function(t,n){return t.time-n.time}).map(function(t){var r,o=Math.round(t.size*config.font_size),u=calcWidth(t.text,o);switch(t.mode){case"R2L":return(r=n(t.time,u,o,t.bottom))?(t.type="R2L",t.stime=r.time,t.poss={x:config.playResX+u/2,y:r.top+o},t.posd={x:-u/2,y:r.top+o},t.dtime=config.r2ltime+t.stime,t):null;case"TOP":case"BOTTOM":return function(n){var r=e(t.time,o,n,t.bottom);return r?(t.type="Fix",t.stime=r.time,t.posd=t.poss={x:Math.round(config.playResX/2),y:r.top+o},t.dtime=config.fixtime+t.stime,t):null}("TOP"===t.mode);default:return null}}).filter(function(t){return t}).sort(function(t,n){return t.stime-n.stime})},fetchXML=function(t,n){if(t.includes("ani.gamer.com.tw")){t=t.match(/https:\/\/ani\.gamer\.com\.tw\/animeVideo\.php\?sn=(\d*)/)[1];var e="https://ani.gamer.com.tw/ajax/danmuGet.php";(r=new ObjectRequest(e)).method="POST",r.data="sn="+t,request(r,function(t){var e=t.responseText;debug("Comments: "+e);var r=JSON.parse(e);debug("Comments: "+e);var o=(new DOMParser).parseFromString('<?xml version="1.0" encoding="utf-8"?><i></i>',"application/xml"),u=o.getElementsByTagName("i");for(var i of Object.values(r))try{var a,c=o.createElement("d");c.innerHTML=i.text.replace(/[^\u4e00-\u9fa5`~\!@#\$%\^\*\(\)_\+\|\-=\\\{\}\[\]:";'\?,\.\/\w\d<>&\u3000-\u303F\u3040-\u309F\u30A0-\u30FF\uFF00-\uFFEF\u4E00-\u9FAF\u2605-\u2606\u2190-\u2195\u203B]/g,"").replace("<","&lt;").replace(">","&gt;").replace("&","&amp;"),a=0==i.position?1:2==i.position?4:1==i.position?5:6;var f=i.time/10+","+a+",25,"+parseInt(i.color.match(/#([\d\w]{6})/)[1],16)+",1550236858,0,55f99b31,12108265626271746";c.setAttribute("p",f),u[0].appendChild(c)}catch(t){debug(t+" "+i.text);continue}e=(new XMLSerializer).serializeToString(o),debug("Comments: "+e),n(e)})}else if(t.includes("api.bilibili.com"))GM_xmlhttpRequest({method:"GET",url:t,onload:function(t){var e=t.responseText.replace(/(?:[\0-\x08\x0B\f\x0E-\x1F\uFFFE\uFFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])/g,"");n(e)}});else if(t.includes("danmu.aixifan.com")){e=t.replace(/\d$/,AcfunCount);var r=new ObjectRequest(e);request(r,function(o){var u=o.responseText;comments=u;var i=JSON.parse(comments);AcfunDanmaku=AcfunDanmaku.concat(i),debug("AcfunDanmaku.length: "+AcfunDanmaku[2].length),AcfunDanmaku[2].length>=500?(AcfunCount++,e=t.replace(/\d$/,AcfunCount),r.url=e,request(r,function(o){u=o.responseText,comments=u,i=JSON.parse(comments),AcfunDanmaku=AcfunDanmaku.concat(i),debug("AcfunDanmaku.length: "+AcfunDanmaku.length),AcfunDanmaku.length>=1e3?(AcfunCount++,e=t.replace(/\d$/,AcfunCount),r.url=e,request(r,function(t){u=t.responseText,comments=u,i=JSON.parse(comments),AcfunDanmaku=AcfunDanmaku.concat(i),comments=AcfunParse(AcfunDanmaku),n(comments)})):(comments=AcfunParse(AcfunDanmaku),n(comments))})):(comments=AcfunParse(AcfunDanmaku),n(comments))}),AcfunDanmaku=[],AcfunCount=1}},fetchDanmaku=function(t,n){fetchXML(t,function(t){n(parseXML(t))})},parseXML=function(t){var n=(new DOMParser).parseFromString(t,"text/xml");return Array.apply(Array,n.querySelectorAll("d")).map(function(t){var n=t.getAttribute("p").split(",");return{text:t.textContent,time:Number(n[0]),mode:[void 0,"R2L","R2L","R2L","BOTTOM","TOP"][Number(n[1])],size:Number(n[2]),color:RRGGBB(16777215&parseInt(n[3],10)),bottom:Number(n[5])>0}})},getCid=function(t){debug("get cid...");var n=null;try{n=input.value.match(/.* - (https?:\/\/.*)/)[1]}catch(t){var e=input.value.match(matching);null!=e&&(null!=e[2]?n=e[2]:null!=e[1]&&(n=e[1]))}n?setTimeout(t,0,n||void 0):setTimeout(getCid,100,t)},mina=function(t){getCid(function(n){fetchDanmaku(n=n||t,function(t){var n=null;try{n=input.value.match(/Search Result: (.*) - https?:\/\/.*/)[1]}catch(t){n=document.title}debug("got xml with %d danmaku",t.length);var e=generateASS(setPosition(t),{title:document.title,ori:location.href});startDownload("\ufeff"+e,n+".ass")})})},initButton=function(){var t=!1;return function(){debug("init button"),document.querySelector("body")&&getCid(function(n){debug("cid = %o",n),n&&!t&&(t=!0,fetchDanmaku(n,function(t){CreateButton("Download Danmaku",function(){mina(n)})}))})}}(),DanmakuDownloaderInit=function(){IsDownload=!0,initFont(),initButton()};
...
function init(){
    ...
    if(window.location.href.includes("bilibili.com")){
        ...
        CreateButton('Detect cid',function () {
            ...
            CreateButton('Search Danmaku',function () {
                if(input.value==""&&datalist==null){
                    ...
                    var CheckValue=setInterval(function () {
                        if(SearchFinished&&input.value.match(matching)){
                            ...
                            input.nextElementSibling.innerHTML='Search Failed';
                            clearInterval(CheckValue);
...
function bahamut(){
    ...
    request(search,function (responseDetails) {
        ...
        if(anime_list==null||anime_list.classList.length>1){
            ...
            href = animelook.href;
            href = href.replace(window.location.href, "https://ani.gamer.com.tw/").replace("https://"+getLocation(window.location.href).hostname+"/", "https://ani.gamer.com.tw/");
            debug(href);
        ...
        if(search_list==null){
            ...
            request(GetAnime,function (responseDetails) {
                ...
                if(PushEnable){
                    ...
                    messages.push(['[Notice] tucao.one search success, "!dm:xxx" available.',5000,null]);
                }
                TucaoStatus=true;
                    GetDanmaku(OtherInsertTucao);
            });
        }
    });
...
function DanmakuPost(comment){
    ...
    object.data=JSON.stringify({
        'message':encodeURI(comment.text),
        'color':comment.color,
        'stime':parseInt(comment.stime/1000),
...
function GetDanmaku(func) {
    ...
    if(func.name!="OtherInsertTucao"){
        ...
        try{
            ...
            DanmakuLink=DanmakuLink.match(/(https:\/\/www\.tucao\.one\/index\.php\?m=mukio&c=index&a=init&playerID=\d*-\d*-\d*-\d*)/)[1];
        }
        catch(e){
                ...
                switch (command) {
                    ...
                    case "danmaku": {
                        if(TucaoStatus){
                            ...
                            if (params!=null) {
                                ...
                                if(params.length==3){
                                    ...
                                    if(["black","blue","green","orange","pink","purple","red","silver","yellow","white","gold"].includes(color)){
                                        ...
                                        abp.createPopup("[Error] color wrong.", 2000);

                                    }

                                }
                                else {
                                    abp.createPopup("[Error] {{type,size,color}}.", 2000);
                                }
                            ...
                            abp.createPopup('[Error] tucao.one search failed, "!dm:xxx" unavailable.', 2000);
                        }
                    }
                        break;
                    case "comment": {
...
function OtherInsertTucao(comments){
    ...
    for (var node of nodes){
        //debug(node.innerHTML);
        var params=node.getAttribute("p").split(",");
        var comment = {
            'text': "[www.tucao.one]"+node.innerHTML,
            'stime': parseInt(params[0]) * 1000 - 1,
            'mode': params[1],
            'color': params[3],
            'border': false
        };
